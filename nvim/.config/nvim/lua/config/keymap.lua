...
vim.keymap.set("n", "<leader>fc", "<CMD>FzfLua files cwd=~/.config/nvim<CR>", { desc = "Fuzzy find files in current directory" })
...
vim.keymap.set("n", "gl", function() vim.diagnostic.open_float() end, { desc = "Open diagnostics window" })
vim.keymap.set("n", "<leader>fm", function() require('conform').format() end, { desc = "Format the current buffer"   })
